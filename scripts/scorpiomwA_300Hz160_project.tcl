...
# Add FPA Files
add_files [concat \
   [glob -nocomplain $scorpiomwA_path/HDL/*.vhd] \
...
set iplist [get_ips -filter {NAME =~ "*serdes*mmcm" || NAME =~ "*fifo*" || NAME =~ "*video_mgt*" || NAME =~ "scorpiomwA*mmcm"}]
foreach ip $iplist {
