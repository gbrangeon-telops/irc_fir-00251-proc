...
validate_bd_design
save_bd_design
source $script_dir/gen_bd_core_${FPGA_SIZE}_4DDR.tcl
validate_bd_design
save_bd_design
...
make_wrapper -files [get_files $ip_dir/managed_ip_project/managed_ip_project.srcs/sources_1/bd/core_4DDR/core_4DDR.bd] -top
