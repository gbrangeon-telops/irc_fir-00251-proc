...
proc write_mig_file_core_mig_7series_0_1 { str_mig_prj_filepath } {
...
# End of write_mig_file_core_mig_7series_0_1()
...
proc create_hier_cell_microblaze_1_local_memory { parentCell nameHier } {
  ...
  set_property -dict [ list CONFIG.C_ECC {0} CONFIG.C_NUM_LMB {1}  ] $dlmb_bram_if_cntlr

  # Create instance: dlmb_v10, and set properties
  set dlmb_v10 [ create_bd_cell -type ip -vlnv xilinx.com:ip:lmb_v10:3.0 dlmb_v10 ]
  set_property -dict [ list CONFIG.C_LMB_NUM_SLAVES {1}  ] $dlmb_v10

  # Create instance: ilmb_bram_if_cntlr, and set properties
  set ilmb_bram_if_cntlr [ create_bd_cell -type ip -vlnv xilinx.com:ip:lmb_bram_if_cntlr:4.0 ilmb_bram_if_cntlr ]
  set_property -dict [ list CONFIG.C_ECC {0} CONFIG.C_NUM_LMB {1}  ] $ilmb_bram_if_cntlr

  # Create instance: ilmb_v10, and set properties
  set ilmb_v10 [ create_bd_cell -type ip -vlnv xilinx.com:ip:lmb_v10:3.0 ilmb_v10 ]
  set_property -dict [ list CONFIG.C_LMB_NUM_SLAVES {1}  ] $ilmb_v10
...
proc create_hier_cell_axi_peripheral { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     puts "ERROR: create_hier_cell_axi_peripheral() - Empty argument(s)!"
     return
  }
  ...
  set_property -dict [ list CONFIG.NUM_MI {16} CONFIG.S00_HAS_DATA_FIFO {2}  ] $axi_interconnect_0

  # Create instance: axi_interconnect_1, and set properties
  set axi_interconnect_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_1 ]
  set_property -dict [ list CONFIG.M00_HAS_DATA_FIFO {2} CONFIG.M01_HAS_DATA_FIFO {2} CONFIG.M11_HAS_DATA_FIFO {2} CONFIG.M12_HAS_DATA_FIFO {2} CONFIG.M15_HAS_DATA_FIFO {1} CONFIG.NUM_MI {14} CONFIG.S00_HAS_DATA_FIFO {2}  ] $axi_interconnect_1

  # Create instance: axi_interconnect_2, and set properties
  set axi_interconnect_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_2 ]
  set_property -dict [ list CONFIG.NUM_MI {9}  ] $axi_interconnect_2
  ...
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins M_LENS_UART_AXI] [get_bd_intf_pins axi_interconnect_2/M08_AXI]
...
proc create_hier_cell_MIG_Code { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     puts "ERROR: create_hier_cell_MIG_Code() - Empty argument(s)!"
     return
  }
  ...
  write_mig_file_core_mig_7series_0_1 $str_mig_file_path
  ...
  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK]
...
proc create_hier_cell_MIG_Calibration { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     puts "ERROR: create_hier_cell_MIG_Calibration() - Empty argument(s)!"
     return
  }
  ...
  # Create pins
  create_bd_pin -dir I -from 0 -to 0 INTERCONNECT_ARESETN
  create_bd_pin -dir I MB_AXI_ACLK
  create_bd_pin -dir I M_AXI_CALDDR_MM2S_ACLK
  create_bd_pin -dir I -from 0 -to 0 -type rst PERIPHERAL_ARESETN
  create_bd_pin -dir I clk_data_160M
  create_bd_pin -dir I clk_data_80M
  create_bd_pin -dir I -from 11 -to 0 device_temp_i
  create_bd_pin -dir I -from 0 -to 0 -type rst sys_rst

  # Create instance: CAL_DDR_MIG, and set properties
  set CAL_DDR_MIG [ create_bd_cell -type ip -vlnv xilinx.com:ip:mig_7series:2.0 CAL_DDR_MIG ]
  ...
  set_property -dict [ list CONFIG.RESET_BOARD_INTERFACE {Custom} CONFIG.XML_INPUT_FILE {mig_b.prj}  ] $CAL_DDR_MIG
  ...
  set_property -dict [ list CONFIG.c_enable_mm2s {1} CONFIG.c_enable_s2mm {0} CONFIG.c_m_axi_mm2s_data_width {128} CONFIG.c_m_axis_mm2s_tdata_width {64} CONFIG.c_mm2s_burst_size {32}  ] $axi_datamover_ddrcal
  ...
  set_property -dict [ list CONFIG.c_m_axi_mm2s_data_width {128} CONFIG.c_m_axi_s2mm_data_width {128} CONFIG.c_m_axis_mm2s_tdata_width {16} CONFIG.c_mm2s_btt_used {23} CONFIG.c_mm2s_burst_size {32} CONFIG.c_s2mm_btt_used {23} CONFIG.c_s2mm_burst_size {128}  ] $axi_dm_buffer
  ...
  set_property -dict [ list CONFIG.M00_HAS_DATA_FIFO {2} CONFIG.NUM_MI {1} CONFIG.NUM_SI {4} CONFIG.S00_HAS_DATA_FIFO {2} CONFIG.S01_HAS_DATA_FIFO {2} CONFIG.S02_HAS_DATA_FIFO {2} CONFIG.S03_HAS_DATA_FIFO {2} CONFIG.S04_HAS_DATA_FIFO {2}  ] $axi_interconnect_ddrcal
  ...
  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins MB_AXI_ACLK] [get_bd_pins axi_interconnect_ddrcal/S00_ACLK]
  ...
  connect_bd_net -net S02_ACLK_1 [get_bd_pins clk_data_80M] [get_bd_pins axi_dm_buffer/m_axi_mm2s_aclk] [get_bd_pins axi_dm_buffer/m_axi_s2mm_aclk] [get_bd_pins axi_dm_buffer/m_axis_mm2s_cmdsts_aclk] [get_bd_pins axi_dm_buffer/m_axis_s2mm_cmdsts_awclk] [get_bd_pins axi_interconnect_ddrcal/S02_ACLK] [get_bd_pins axi_interconnect_ddrcal/S03_ACLK]
  connect_bd_net -net ext_reset_in_1 [get_bd_pins sys_rst] [get_bd_pins CAL_DDR_MIG/sys_rst]
  connect_bd_net -net m_axi_mm2s_aclk_1 [get_bd_pins M_AXI_CALDDR_MM2S_ACLK] [get_bd_pins axi_datamover_ddrcal/m_axi_mm2s_aclk] [get_bd_pins axi_datamover_ddrcal/m_axis_mm2s_cmdsts_aclk] [get_bd_pins axi_interconnect_ddrcal/S01_ACLK]
  connect_bd_net -net m_axi_mm2s_aclk_2 [get_bd_pins clk_data_160M]
...
proc create_hier_cell_MCU { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 14 -to 0 intr
  ...
  set_property -dict [ list CONFIG.C_BRANCH_TARGET_CACHE_SIZE {0} CONFIG.C_CACHE_BYTE_SIZE {16384} CONFIG.C_DCACHE_BYTE_SIZE {16384} CONFIG.C_DEBUG_ENABLED {1} CONFIG.C_D_AXI {1} CONFIG.C_D_LMB {1} CONFIG.C_ENABLE_DISCRETE_PORTS {1} CONFIG.C_FAULT_TOLERANT {0} CONFIG.C_FSL_LINKS {1} CONFIG.C_ICACHE_STREAMS {1} CONFIG.C_I_AXI {0} CONFIG.C_I_LMB {1} CONFIG.C_NUMBER_OF_PC_BRK {2} CONFIG.C_NUMBER_OF_RD_ADDR_BRK {1} CONFIG.C_NUMBER_OF_WR_ADDR_BRK {1} CONFIG.C_USE_DCACHE {1} CONFIG.C_USE_DIV {0} CONFIG.C_USE_FPU {1} CONFIG.C_USE_HW_MUL {1} CONFIG.C_USE_ICACHE {1} CONFIG.C_USE_INTERRUPT {2} CONFIG.C_USE_STACK_PROTECTION {1} CONFIG.G_TEMPLATE_LIST {0} CONFIG.G_USE_EXCEPTIONS {1}  ] $microblaze_1
  ...
  set_property -dict [ list CONFIG.C_HAS_FAST {1}  ] $microblaze_1_axi_intc

  # Create instance: microblaze_1_local_memory
  create_hier_cell_microblaze_1_local_memory $hier_obj microblaze_1_local_memory

  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_mdm_axi] [get_bd_intf_pins mdm_1/S_AXI]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins AXIS_USART_RX] [get_bd_intf_pins microblaze_1/S0_AXIS]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins AXIS_USART_TX] [get_bd_intf_pins microblaze_1/M0_AXIS]
  ...
  connect_bd_intf_net -intf_net microblaze_1_intc_axi [get_bd_intf_pins s_intc_axi] [get_bd_intf_pins microblaze_1_axi_intc/s_axi]
  ...
  connect_bd_net -net microblaze_1_Clk [get_bd_pins Clk] [get_bd_pins microblaze_1/Clk] [get_bd_pins microblaze_1_axi_intc/processor_clk] [get_bd_pins microblaze_1_axi_intc/s_axi_aclk] [get_bd_pins microblaze_1_local_memory/LMB_Clk]
  connect_bd_net -net proc_sys_reset_1_bus_struct_reset [get_bd_pins LMB_Rst] [get_bd_pins microblaze_1_local_memory/LMB_Rst]
  connect_bd_net -net proc_sys_reset_1_mb_reset [get_bd_pins Reset] [get_bd_pins microblaze_1/Reset] [get_bd_pins microblaze_1_axi_intc/processor_rst]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins microblaze_1_axi_intc/s_axi_aresetn]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins S_AXI_ACLK] [get_bd_pins mdm_1/S_AXI_ACLK]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins S_AXI_ARESETN] [get_bd_pins mdm_1/S_AXI_ARESETN]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $ADC_READOUT_CTRL
  set AEC_CTRL [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 AEC_CTRL ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $AEC_CTRL
  set CALIBCONFIG_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 CALIBCONFIG_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $CALIBCONFIG_AXI
  set CALIB_RAM_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 CALIB_RAM_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $CALIB_RAM_AXI
  set CAL_DDR [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddrx_rtl:1.0 CAL_DDR ]
  set CLINK_UART [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 CLINK_UART ]
  ...
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $EXPTIME_CTRL
  set FAN_CTRL [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 FAN_CTRL ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $FAN_CTRL
  set FPA_CTRL [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 FPA_CTRL ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $FPA_CTRL
  set FPGA_UART [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 FPGA_UART ]
  set FW_UART [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 FW_UART ]
  set HEADER_CTRL [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 HEADER_CTRL ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $HEADER_CTRL
  set IRIG_CTRL [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 IRIG_CTRL ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $IRIG_CTRL
  ...
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $MGT_CTRL
  ...
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M_BUFFERING_CTRL
  set M_BUF_TABLE [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_BUF_TABLE ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M_BUF_TABLE
  set M_BULK_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_BULK_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M_BULK_AXI
  set M_EHDRI_CTRL [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_EHDRI_CTRL ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4}  ] $M_EHDRI_CTRL
  set M_FLASHINTF_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_FLASHINTF_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4}  ] $M_FLASHINTF_AXI
  set M_ICU_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_ICU_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M_ICU_AXI
  set NDF_UART [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 NDF_UART ]
  set NLC_LUT_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 NLC_LUT_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $NLC_LUT_AXI
  set OEM_UART [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 OEM_UART ]
  ...
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $RQC_LUT_AXI
  set SFW_CTRL [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 SFW_CTRL ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $SFW_CTRL
  set SYS_CLK_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 SYS_CLK_0 ]
  set_property -dict [ list CONFIG.FREQ_HZ {200000000}  ] $SYS_CLK_0
  ...
  set GPS_UART_SOUT [ create_bd_port -dir O GPS_UART_SOUT ]
  set LENS_UART_SIN [ create_bd_port -dir I LENS_UART_SIN ]
  set LENS_UART_SOUT [ create_bd_port -dir O LENS_UART_SOUT ]
  set M_AXIS_CALDDR_MM2S_ACLK [ create_bd_port -dir I -type clk M_AXIS_CALDDR_MM2S_ACLK ]
  set_property -dict [ list CONFIG.ASSOCIATED_BUSIF {S_AXIS_CALDDR_MM2S_CMD:M_AXIS_CALDDR_MM2S_STS:M_AXIS_CALDDR_MM2S}  ] $M_AXIS_CALDDR_MM2S_ACLK
  ...
  set_property -dict [ list CONFIG.SENSITIVITY {EDGE_RISING}  ] $bulk_interrupt
  set clk_20 [ create_bd_port -dir O -type clk clk_20 ]
  set clk_50 [ create_bd_port -dir O -type clk clk_50 ]
  set clk_80 [ create_bd_port -dir O -type clk clk_80 ]
  set_property -dict [ list CONFIG.ASSOCIATED_BUSIF {S_AXIS_MM2S_CMD_BUF:S_AXIS_S2MM_BUF:S_AXIS_S2MM_CMD_BUF:M_AXIS_S2MM_STS_BUF:M_AXIS_MM2S_STS_BUF:M_AXIS_MM2S_BUF}  ] $clk_80
  set clk_100 [ create_bd_port -dir O -type clk clk_100 ]
  set_property -dict [ list CONFIG.ASSOCIATED_BUSIF {FPA_CTRL:HEADER_CTRL:EXPTIME_CTRL:TRIGGER_CTRL:CALIB_RAM_AXI:AEC_CTRL:SFW_CTRL:CALIBCONFIG_AXI:FAN_CTRL:MGT_CTRL:IRIG_CTRL:M_BULK_AXI:RQC_LUT_AXI:NLC_LUT_AXI:M_FLASHINTF_AXI:M_ICU_AXI:M_BUF_TABLE:M_BUFFERING_CTRL:M_EHDRI_CTRL:M_AXIS_USART:S_AXIS_USART:ADC_READOUT_CTRL}  ] $clk_100
  ...
  set_property -dict [ list CONFIG.C_ALL_INPUTS_2 {1} CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_GPIO2_WIDTH {4} CONFIG.C_GPIO_WIDTH {4} CONFIG.C_IS_DUAL {1}  ] $axi_gpio_0
  ...
  set_property -dict [ list CONFIG.CLKOUT2_DRIVES {BUFG} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {160.0} CONFIG.CLKOUT2_USED {true} CONFIG.CLKOUT3_DRIVES {BUFG} CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {200.0} CONFIG.CLKOUT3_USED {true} CONFIG.CLKOUT4_DRIVES {BUFG} CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {50.0} CONFIG.CLKOUT4_USED {true} CONFIG.CLKOUT5_REQUESTED_OUT_FREQ {20} CONFIG.CLKOUT5_USED {true} CONFIG.CLKOUT6_REQUESTED_OUT_FREQ {80.000} CONFIG.CLKOUT6_USED {true} CONFIG.DIFF_CLK_IN2_BOARD_INTERFACE {Custom} CONFIG.PRIM_SOURCE {Global_buffer} CONFIG.RESET_TYPE {ACTIVE_HIGH} CONFIG.USE_PHASE_ALIGNMENT {true}  ] $clk_wiz_1
  ...
  set intr_concact [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:1.0 intr_concact ]
  set_property -dict [ list CONFIG.NUM_PORTS {16}  ] $intr_concact
  ...
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {0} CONFIG.C_ALL_OUTPUTS_2 {1} CONFIG.C_GPIO2_WIDTH {5} CONFIG.C_GPIO_WIDTH {11} CONFIG.C_INTERRUPT_PRESENT {1} CONFIG.C_IS_DUAL {1} CONFIG.C_TRI_DEFAULT {0xFFFFFC00}  ] $power_management

  # Create instance: proc_sys_reset_1, and set properties
  set proc_sys_reset_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_1 ]
  set_property -dict [ list CONFIG.C_AUX_RESET_HIGH {1} CONFIG.C_AUX_RST_WIDTH {1}  ] $proc_sys_reset_1
  ...
  connect_bd_intf_net -intf_net axi_ndf_uart_UART [get_bd_intf_ports NDF_UART] [get_bd_intf_pins axi_ndf_uart/UART]
  ...
  connect_bd_intf_net -intf_net axi_peripheral_M08_AXI1 [get_bd_intf_pins axi_lens_uart/S_AXI] [get_bd_intf_pins axi_peripheral/M_LENS_UART_AXI]
  connect_bd_intf_net -intf_net axi_peripheral_M14_AXI [get_bd_intf_pins axi_peripheral/M_QSPI_AXI] [get_bd_intf_pins axi_quad_spi_0/AXI_LITE]
  ...
  connect_bd_intf_net -intf_net axi_uart16550_0_uart [get_bd_intf_ports CLINK_UART] [get_bd_intf_pins clink_uart/UART]
  connect_bd_intf_net -intf_net axi_usb_uart_uart [get_bd_intf_ports USB_UART] [get_bd_intf_pins axi_usb_uart/UART]
  connect_bd_intf_net -intf_net fpga_output_uart_uart [get_bd_intf_ports FPGA_UART] [get_bd_intf_pins fpga_output_uart/UART]
  connect_bd_intf_net -intf_net fw_uart_UART [get_bd_intf_ports FW_UART] [get_bd_intf_pins fw_uart/UART]
  ...
  connect_bd_intf_net -intf_net oem_uart_uart [get_bd_intf_ports OEM_UART] [get_bd_intf_pins oem_uart/UART]
  ...
  connect_bd_net -net axi_lens_uart_ip2intc_irpt [get_bd_pins axi_lens_uart/ip2intc_irpt] [get_bd_pins intr_concact/In15]
  ...
  connect_bd_net -net clk100 [get_bd_ports clk_100] [get_bd_pins MCU/Clk] [get_bd_pins MCU/S_AXI_ACLK] [get_bd_pins MIG_Calibration/MB_AXI_ACLK] [get_bd_pins MIG_Code/ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gps_uart/s_axi_aclk] [get_bd_pins axi_lens_uart/s_axi_aclk] [get_bd_pins axi_ndf_uart/s_axi_aclk] [get_bd_pins axi_peripheral/aclk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_usb_uart/s_axi_aclk] [get_bd_pins clink_uart/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins fpga_output_uart/s_axi_aclk] [get_bd_pins fw_uart/s_axi_aclk] [get_bd_pins oem_uart/s_axi_aclk] [get_bd_pins pleora_uart/s_axi_aclk] [get_bd_pins power_management/s_axi_aclk] [get_bd_pins xadc_wiz_1/s_axi_aclk]
  connect_bd_net -net clk160 [get_bd_ports clk_160] [get_bd_pins MIG_Calibration/clk_data_160M] [get_bd_pins clk_wiz_1/clk_out2]
  connect_bd_net -net clk200 [get_bd_ports clk_200] [get_bd_pins clk_wiz_1/clk_out3]
  connect_bd_net -net clk_wiz_1_clk_out5 [get_bd_ports clk_20] [get_bd_pins clk_wiz_1/clk_out5]
  connect_bd_net -net clk_wiz_1_clk_out6 [get_bd_ports clk_80] [get_bd_pins MIG_Calibration/clk_data_80M] [get_bd_pins clk_wiz_1/clk_out6]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins proc_sys_reset_1/dcm_locked]
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_nets clk_wiz_1_locked]
  connect_bd_net -net cooler_uart_ip2intc_irpt [get_bd_pins axi_ndf_uart/ip2intc_irpt] [get_bd_pins intr_concact/In14]
  connect_bd_net -net ext_reset_in_1 [get_bd_pins GND/const] [get_bd_pins MIG_Calibration/sys_rst] [get_bd_pins MIG_Code/sys_rst] [get_bd_pins clk_wiz_1/reset] [get_bd_pins proc_sys_reset_1/aux_reset_in]
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_nets ext_reset_in_1]
  connect_bd_net -net fpga_output_uart_ip2intc_irpt [get_bd_pins fpga_output_uart/ip2intc_irpt] [get_bd_pins intr_concact/In6]
  connect_bd_net -net fw_uart_ip2intc_irpt [get_bd_pins fw_uart/ip2intc_irpt] [get_bd_pins intr_concact/In12]
  connect_bd_net -net m_axi_mm2s_aclk_1 [get_bd_ports M_AXIS_CALDDR_MM2S_ACLK] [get_bd_pins MIG_Calibration/M_AXI_CALDDR_MM2S_ACLK]
  connect_bd_net -net mcu_debug_sys_rst [get_bd_pins MCU/Debug_SYS_Rst] [get_bd_pins proc_sys_reset_1/mb_debug_sys_rst]
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_nets mcu_debug_sys_rst]
  connect_bd_net -net mcu_interrupt [get_bd_pins MCU/Interrupt] [get_bd_pins intr_concact/In0]
  connect_bd_net -net microblaze_1_xlconcat_dout [get_bd_pins MCU/intr] [get_bd_pins intr_concact/dout]
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_nets microblaze_1_xlconcat_dout]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins MIG_Code/ui_clk] [get_bd_pins clk_wiz_1/clk_in1]
  connect_bd_net -net oem_uart_ip2intc_irpt [get_bd_pins intr_concact/In1] [get_bd_pins oem_uart/ip2intc_irpt]
  connect_bd_net -net pleora_uart_ip2intc_irpt [get_bd_pins intr_concact/In5] [get_bd_pins pleora_uart/ip2intc_irpt]
  connect_bd_net -net pleora_uart_sout [get_bd_ports PLEORA_UART_SOUT] [get_bd_pins pleora_uart/sout]
  connect_bd_net -net power_management_ip2intc_irpt [get_bd_pins intr_concact/In13] [get_bd_pins power_management/ip2intc_irpt]
  ...
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_nets proc_sys_reset_1_bus_struct_reset]
  ...
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_nets proc_sys_reset_1_interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_mb_reset [get_bd_pins MCU/Reset] [get_bd_pins proc_sys_reset_1/mb_reset]
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_nets proc_sys_reset_1_mb_reset]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_ports ARESETN] [get_bd_pins MCU/S00_ARESETN] [get_bd_pins MCU/S_AXI_ARESETN] [get_bd_pins MIG_Calibration/PERIPHERAL_ARESETN] [get_bd_pins MIG_Code/PERIPHERAL_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gps_uart/s_axi_aresetn] [get_bd_pins axi_lens_uart/s_axi_aresetn] [get_bd_pins axi_ndf_uart/s_axi_aresetn] [get_bd_pins axi_peripheral/PERIPHERAL_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_usb_uart/s_axi_aresetn] [get_bd_pins clink_uart/s_axi_aresetn] [get_bd_pins fpga_output_uart/s_axi_aresetn] [get_bd_pins fw_uart/s_axi_aresetn] [get_bd_pins oem_uart/s_axi_aresetn] [get_bd_pins pleora_uart/s_axi_aresetn] [get_bd_pins power_management/s_axi_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins xadc_wiz_1/s_axi_aresetn]
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_nets proc_sys_reset_1_peripheral_aresetn]
  connect_bd_net -net sin_1 [get_bd_ports GPS_UART_SIN] [get_bd_pins axi_gps_uart/sin]
  connect_bd_net -net sin_2 [get_bd_ports PLEORA_UART_SIN] [get_bd_pins pleora_uart/sin]
  connect_bd_net -net sin_3 [get_bd_ports LENS_UART_SIN] [get_bd_pins axi_lens_uart/sin]
  connect_bd_net -net vcc_const [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins vcc/const]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x40000000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x2000 -offset 0x40410000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs axi_lens_uart/S_AXI/Reg] SEG_axi_lens_uart_Reg
  create_bd_addr_seg -range 0x2000 -offset 0x4040E000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs axi_ndf_uart/S_AXI/Reg] SEG_axi_ndf_uart_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x44A90000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs axi_quad_spi_0/AXI_LITE/Reg] SEG_axi_quad_spi_0_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x41C00000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs axi_timer_0/S_AXI/Reg] SEG_axi_timer_0_Reg
  create_bd_addr_seg -range 0x2000 -offset 0x40400000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs axi_gps_uart/S_AXI/Reg] SEG_axi_uart16550_0_Reg
  create_bd_addr_seg -range 0x2000 -offset 0x40402000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs axi_usb_uart/S_AXI/Reg] SEG_axi_usb_uart_Reg
  create_bd_addr_seg -range 0x2000 -offset 0x40404000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs clink_uart/S_AXI/Reg] SEG_clink_uart_Reg
  create_bd_addr_seg -range 0x8000 -offset 0x0 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs MCU/microblaze_1_local_memory/dlmb_bram_if_cntlr/SLMB/Mem] SEG_dlmb_bram_if_cntlr_Mem
  create_bd_addr_seg -range 0x2000 -offset 0x40406000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs fpga_output_uart/S_AXI/Reg] SEG_fpga_output_uart_Reg
  create_bd_addr_seg -range 0x2000 -offset 0x4040C000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs fw_uart/S_AXI/Reg] SEG_fw_uart_Reg
  create_bd_addr_seg -range 0x8000 -offset 0x0 [get_bd_addr_spaces MCU/microblaze_1/Instruction] [get_bd_addr_segs MCU/microblaze_1_local_memory/ilmb_bram_if_cntlr/SLMB/Mem] SEG_ilmb_bram_if_cntlr_Mem
  create_bd_addr_seg -range 0x1000 -offset 0x41400000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs MCU/mdm_1/S_AXI/Reg] SEG_mdm_1_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x41200000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs MCU/microblaze_1_axi_intc/s_axi/Reg] SEG_microblaze_1_axi_intc_Reg
  create_bd_addr_seg -range 0x10000000 -offset 0x50000000 [get_bd_addr_spaces MCU/microblaze_1/Instruction] [get_bd_addr_segs MIG_Code/mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  create_bd_addr_seg -range 0x10000000 -offset 0x50000000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs MIG_Code/mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  create_bd_addr_seg -range 0x2000 -offset 0x40408000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs oem_uart/S_AXI/Reg] SEG_oem_uart_Reg
  create_bd_addr_seg -range 0x2000 -offset 0x4040A000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs pleora_uart/S_AXI/Reg] SEG_pleora_uart_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x40010000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs power_management/S_AXI/Reg] SEG_power_management_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x44B00000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs xadc_wiz_1/s_axi_lite/Reg] SEG_xadc_wiz_1_Reg
  create_bd_addr_seg -range 0x1000 -offset 0x44B50000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs ADC_READOUT_CTRL/Reg] TEL_ADC_READOUT_CTRL
  create_bd_addr_seg -range 0x1000 -offset 0x44A00000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs AEC_CTRL/Reg] TEL_AEC_CTRL
  create_bd_addr_seg -range 0x10000 -offset 0x44A40000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs M_BUFFERING_CTRL/Reg] TEL_BUFFERING_CTRL
  create_bd_addr_seg -range 0x10000 -offset 0x44B30000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs M_BUF_TABLE/Reg] TEL_BUFTABLE
  create_bd_addr_seg -range 0x1000 -offset 0x44A10000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs CALIB_RAM_AXI/Reg] TEL_CALIB_RAM
  create_bd_addr_seg -range 0x4000 -offset 0x44A20000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs CALIBCONFIG_AXI/Reg] TEL_CAL_CTRL
  create_bd_addr_seg -range 0x1000 -offset 0x44B40000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs M_EHDRI_CTRL/Reg] TEL_EHDRI_CTRL
  create_bd_addr_seg -range 0x1000 -offset 0x44A30000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs EXPTIME_CTRL/Reg] TEL_EXPTIM_CTRL
  create_bd_addr_seg -range 0x1000 -offset 0x44AA0000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs FAN_CTRL/Reg] TEL_FAN_CTRL
  create_bd_addr_seg -range 0x4000 -offset 0x44B10000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs M_FLASHINTF_AXI/Reg] TEL_FLASH_INTF
  create_bd_addr_seg -range 0x1000 -offset 0x44A50000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs FPA_CTRL/Reg] TEL_FPA_CTRL
  create_bd_addr_seg -range 0x1000 -offset 0x44A60000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs HEADER_CTRL/Reg] TEL_HEADER_CTRL
  create_bd_addr_seg -range 0x1000 -offset 0x44B20000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs M_ICU_AXI/Reg] TEL_ICU_CTRL
  create_bd_addr_seg -range 0x1000 -offset 0x44AC0000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs IRIG_CTRL/Reg] TEL_IRIG_CTRL
  create_bd_addr_seg -range 0x1000 -offset 0x44AB0000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs MGT_CTRL/Reg] TEL_MGT_CTRL
  create_bd_addr_seg -range 0x4000 -offset 0x44AF0000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs NLC_LUT_AXI/Reg] TEL_NLC_LUT
  create_bd_addr_seg -range 0x8000 -offset 0x44AE0000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs RQC_LUT_AXI/Reg] TEL_RQC_LUT
  create_bd_addr_seg -range 0x1000 -offset 0x44A70000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs SFW_CTRL/Reg] TEL_SFW_CTRL
  create_bd_addr_seg -range 0x1000 -offset 0x44A80000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs TRIGGER_CTRL/Reg] TEL_TRIGGER_CTRL
  create_bd_addr_seg -range 0x2000 -offset 0x44AD0000 [get_bd_addr_spaces MCU/microblaze_1/Data] [get_bd_addr_segs M_BULK_AXI/Reg] TEL_USART_CTRL
