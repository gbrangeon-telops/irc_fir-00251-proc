 ...
 * Frame buffer
 */
#define PROC_MEM_FRAME_BUFFER_BASEADDR      (PROC_MEM_USART_RXBUFFER_HIGHADDR + 1)
#define PROC_MEM_FRAME_BUFFER_SIZE          (FB_FRAME_BUFFER_SIZE)
#define PROC_MEM_FRAME_BUFFER_HIGHADDR      (PROC_MEM_FRAME_BUFFER_BASEADDR + PROC_MEM_FRAME_BUFFER_SIZE - 1)

/**
 * Internal memory buffer
 */

#define PROC_MEM_MEMORY_BUFFER_BASEADDR      (PROC_MEM_FRAME_BUFFER_HIGHADDR + 1)
