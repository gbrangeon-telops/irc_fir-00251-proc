...
#define WAITING_FOR_ADC_DDC_SENSOR_DELAY_US     (6 * TIME_ONE_SECOND_US) // waiting delay before validating the ADC board presence, because it takes some time to initialize
...
#define COOLDOWN_STABILITY_PERIOD_US            TIME_ONE_MINUTE_US
