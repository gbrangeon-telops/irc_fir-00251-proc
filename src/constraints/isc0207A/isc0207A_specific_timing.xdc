...
set_clock_groups -asynchronous -group {mclk_source_isc0207A_5_0_MHz_mmcm_1}

set_clock_groups -asynchronous -group {quad_phase_clk_hawkA_10MHz_mmcm}
set_clock_groups -asynchronous -group {quad_phase_clk_hawkA_10MHz_mmcm_1}
