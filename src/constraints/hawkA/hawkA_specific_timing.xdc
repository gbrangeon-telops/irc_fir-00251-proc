...
set_clock_groups -asynchronous -group {mclk_source_hawkA_10MHz_mmcm}
set_clock_groups -asynchronous -group {mclk_source_hawkA_10MHz_mmcm_1}

set_clock_groups -asynchronous -group {adc_phase_clk_hawkA_10MHz_mmcm}
set_clock_groups -asynchronous -group {adc_phase_clk_hawkA_10MHz_mmcm_1}
