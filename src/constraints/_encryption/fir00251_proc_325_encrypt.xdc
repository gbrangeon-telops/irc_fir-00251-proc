...
#set_property BITSTREAM.ENCRYPTION.KEYFILE {\\stark\test$\xc7k325t_irc.nky} [current_design]
#set_property BITSTREAM.ENCRYPTION.KEYFILE {\\stark\test$\xc7k325t_kit.nky} [current_design]
