...
set_property IOSTANDARD SSTL135 [get_ports POWER_ON_ADC_DDC]
set_property IOSTANDARD SSTL135 [get_ports POWER_ON_BUFFER]
set_property IOSTANDARD SSTL135 [get_ports POWER_ON_COOLER]
set_property IOSTANDARD SSTL135 [get_ports POWER_ON_EXPANSION]
set_property IOSTANDARD SSTL135 [get_ports POWER_ON_PLEORA]
set_property IOSTANDARD SSTL135 [get_ports POWER_ON_SFW]
set_property IOSTANDARD SSTL135 [get_ports POWER_ON_SPARE1]
set_property IOSTANDARD SSTL135 [get_ports POWER_ON_SPARE2]
set_property IOSTANDARD SSTL135 [get_ports PWR_SPARE]
...
set_property IOSTANDARD SSTL135 [get_ports LED_RED]
set_property IOSTANDARD SSTL135 [get_ports LED_GREEN]
set_property IOSTANDARD SSTL135 [get_ports LED_YELLOW]
set_property IOSTANDARD LVCMOS33 [get_ports SELF_RESET]
set_property IOSTANDARD SSTL135 [get_ports BUTTON]
...
set_property IOSTANDARD SSTL135 [get_ports WATER_LEVEL]
