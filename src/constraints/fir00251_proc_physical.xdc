...
set_property PACKAGE_PIN C17 [get_ports REV_GPIO[7]]
set_property PACKAGE_PIN C18 [get_ports REV_GPIO[6]]
set_property PACKAGE_PIN C19 [get_ports REV_GPIO[5]]
set_property PACKAGE_PIN B19 [get_ports REV_GPIO[4]]
