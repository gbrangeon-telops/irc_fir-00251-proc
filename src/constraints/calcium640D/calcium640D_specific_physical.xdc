...
set_property PACKAGE_PIN R20 [get_ports {PIX_DATA_N[8]}]
set_property PACKAGE_PIN T23 [get_ports {PIX_DATA_N[4]}]
set_property PACKAGE_PIN M22 [get_ports {PIX_DATA_N[6]}]
set_property PACKAGE_PIN T25 [get_ports {PIX_DATA_N[2]}]
set_property PACKAGE_PIN U20 [get_ports {PIX_DATA_N[1]}]
set_property PACKAGE_PIN T19 [get_ports {PIX_DATA_N[5]}]
set_property PACKAGE_PIN K26 [get_ports {PIX_DATA_N[3]}]
set_property PACKAGE_PIN N17 [get_ports {PIX_DATA_N[7]}]
set_property IOSTANDARD LVDS_25 [get_ports PIX_DATA_*]
set_property DIFF_TERM TRUE [get_ports PIX_DATA_*]
