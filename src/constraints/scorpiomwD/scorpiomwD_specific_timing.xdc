...
# Primary clocks
create_clock -period 50.000 -name CH0_CLK_P -waveform {0.000 25.000} [get_ports CH0_CLK_P]
create_clock -period 50.000 -name CH1_CLK_P -waveform {0.000 25.000} [get_ports CH1_CLK_P]
