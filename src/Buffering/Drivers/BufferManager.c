...
{
   BUFFERING_DBG("GetNumberOfSequenceMax");
...
void BufferManager_SM()
{
   ...
   case BMS_CFG:
      ...
      BUFFERING_INF("max output average bit rate target: " _PCF(2) " Mbps", _FFMT(maxBandWidth/1.0e6,2));
