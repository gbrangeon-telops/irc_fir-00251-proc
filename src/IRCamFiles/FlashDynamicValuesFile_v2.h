...
#define FLASHDYNAMICVALUES_FILEMINORVERSION_V2      4
...
struct FlashDynamicValues_FlashDynamicValuesFileHeader_v2Struct {
   ...
   uint8_t DetectorMode;   /**< Selects speed mode of the detector. */
   float AutofocusROI;   /**< Centered portion (in %) of image used as region of interest by the automatic focus algorithm. */
   uint32_t DeviceStabilizationTime;   /**< Device cooldown time */
   float DeviceStabilizationDeltaTemperature;   /**< Device cooldown temperature difference */
