...
#define FLASHSETTINGS_FILEMAJORVERSION       VER_MACRO(FLASHSETTINGS_FILEMAJORVERSION, TSFSFILES_VERSION)
#define FLASHSETTINGS_FILEMINORVERSION       VER_MACRO(FLASHSETTINGS_FILEMINORVERSION, TSFSFILES_VERSION)
#define FLASHSETTINGS_FILESUBMINORVERSION    VER_MACRO(FLASHSETTINGS_FILESUBMINORVERSION, TSFSFILES_VERSION)
