...
void FlashSettings_PrintFlashSettingsFileHeader_v2(FlashSettings_FlashSettingsFileHeader_v2_t *hdr)
{
   ...
   FPGA_PRINTF("PixelDataResolution: %d bpp\n", hdr->PixelDataResolution);
   ...
   FPGA_PRINTF("ICUPulseWidth: %d ms\n", hdr->ICUPulseWidth);
   FPGA_PRINTF("ICUPeriod: %d ms\n", hdr->ICUPeriod);
   FPGA_PRINTF("ICUTransitionDuration: %d ms\n", hdr->ICUTransitionDuration);
   ...
   FPGA_PRINTF("NDFClearFOVWidth: %d counts\n", hdr->NDFClearFOVWidth);
   ...
   FPGA_PRINTF("FWSpeedMax: %d RPM\n", hdr->FWSpeedMax);
   FPGA_PRINTF("FWEncoderCyclePerTurn: %d counts\n", hdr->FWEncoderCyclePerTurn);
   ...
   FPGA_PRINTF("FWSpeedControllerSwitchingThreshold: %d RPM\n", hdr->FWSpeedControllerSwitchingThreshold);
   ...
   FPGA_PRINTF("BPNumSamples: %d frames\n", hdr->BPNumSamples);
   ...
   FPGA_PRINTF("BPDuration: %d ms\n", hdr->BPDuration);
   FPGA_PRINTF("BPNCoadd: %d frames\n", hdr->BPNCoadd);
   ...
   FPGA_PRINTF("DeviceKeyExpirationPOSIXTime: %d s\n", hdr->DeviceKeyExpirationPOSIXTime);
   ...
   FPGA_PRINTF("ElCorrMeasAtStarvation: %d counts\n", hdr->ElCorrMeasAtStarvation);
   FPGA_PRINTF("ElCorrMeasAtSaturation: %d counts\n", hdr->ElCorrMeasAtSaturation);
   FPGA_PRINTF("ElCorrMeasAtReference1: %d counts\n", hdr->ElCorrMeasAtReference1);
   FPGA_PRINTF("ElCorrMeasAtReference2: %d counts\n", hdr->ElCorrMeasAtReference2);
