...
void CalibSpectralResponse_PrintSpectralResponseDataHeader_v2(CalibSpectralResponse_SpectralResponseDataHeader_v2_t *hdr)
{
   ...
   FPGA_PRINTF("SpectralResponseCurveSize: %u unit\n", hdr->SpectralResponseCurveSize);
   FPGA_PRINTF("Lambda_Exp: %d\n", hdr->Lambda_Exp);
   FPGA_PRINTF("SR_Exp: %d\n", hdr->SR_Exp);
   FPGA_PRINTF("Lambda_Off: " _PCF(3) "\n", _FFMT(hdr->Lambda_Off, 3));
   FPGA_PRINTF("SR_Off: " _PCF(3) "\n", _FFMT(hdr->SR_Off, 3));
   FPGA_PRINTF("Lambda_Nbits: %u bits\n", hdr->Lambda_Nbits);
   FPGA_PRINTF("SR_Nbits: %u bits\n", hdr->SR_Nbits);
   FPGA_PRINTF("Lambda_Signed: %u 0 / 1\n", hdr->Lambda_Signed);
   FPGA_PRINTF("SR_Signed: %u 0 / 1\n", hdr->SR_Signed);
   FPGA_PRINTF("SpectralResponseDataLength: %u bytes\n", hdr->SpectralResponseDataLength);
   FPGA_PRINTF("SpectralResponseDataCRC16: %u\n", hdr->SpectralResponseDataCRC16);
