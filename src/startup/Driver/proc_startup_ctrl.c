 ...
 *  $Rev: 17563 $
 *  $Author: dalain $
 *  $LastChangedDate: 2015-11-30 14:35:06 -0500 (lun., 30 nov. 2015) $
 *  $Id: proc_ctrl.c 17563 2015-11-30 19:35:06Z dalain $
 *  $URL: http://einstein/svn/firmware/FIR-00251-Proc/trunk/src/sw/proc_ctrl.c $
 *
...
#endif
{
   ...
   PRINT("\n");
   FPGA_PRINT("Device started successfully.\n\n");
