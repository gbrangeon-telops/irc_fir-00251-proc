...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set Project {histogram_axis_tmi_4pix}
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{histogram_axis_tmi_4pix_blk_mem_gen_v8_3_i0_vivado.coe}}
		{{histogram_axis_tmi_4pix_entity_declarations.vhd} -lib {work}}
		{{histogram_axis_tmi_4pix.vhd} -lib {work}}
		{{histogram_axis_tmi_4pix_clock.xdc}}
		{{histogram_axis_tmi_4pix.xdc}}
		{{histogram_axis_tmi_4pix.htm}}
	}
	set SimPeriod 1
	set SimTime 1
	...
	set TargetDir {D:/Telops/FIR-00251-Proc/src/AEC/HDL/4pix_netlist_160}
	set TopLevelModule {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface tmi_mosi_rnw DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_tmi_mosi_rnw.dat}
	...
	dict set TopLevelPortInterface tmi_mosi_rnw ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface tmi_mosi_dval DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_tmi_mosi_dval.dat}
	...
	dict set TopLevelPortInterface tmi_mosi_dval ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface tmi_mosi_add DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_tmi_mosi_add.dat}
	...
	dict set TopLevelPortInterface tmi_mosi_add ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface rx_tvalid DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_rx_tvalid.dat}
	...
	dict set TopLevelPortInterface rx_tvalid ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface rx_tready DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_rx_tready.dat}
	...
	dict set TopLevelPortInterface rx_tready ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface rx_tlast DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_rx_tlast.dat}
	...
	dict set TopLevelPortInterface rx_tlast ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface rx_tdata Type UFix_64_0
	dict set TopLevelPortInterface rx_tdata ArithmeticType xlUnsigned
	dict set TopLevelPortInterface rx_tdata BinaryPoint 0
	dict set TopLevelPortInterface rx_tdata Width 64
	dict set TopLevelPortInterface rx_tdata DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_rx_tdata.dat}
	...
	dict set TopLevelPortInterface rx_tdata ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface msb_pos DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_msb_pos.dat}
	...
	dict set TopLevelPortInterface msb_pos ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface ext_data_in2 DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_ext_data_in2.dat}
	...
	dict set TopLevelPortInterface ext_data_in2 ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface ext_data_in DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_ext_data_in.dat}
	...
	dict set TopLevelPortInterface ext_data_in ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface clear_mem DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_clear_mem.dat}
	...
	dict set TopLevelPortInterface clear_mem ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface areset DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_areset.dat}
	...
	dict set TopLevelPortInterface areset ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface ext_data_out DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_ext_data_out.dat}
	...
	dict set TopLevelPortInterface ext_data_out ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface ext_data_out2 DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_ext_data_out2.dat}
	...
	dict set TopLevelPortInterface ext_data_out2 ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface histogram_rdy DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_histogram_rdy.dat}
	...
	dict set TopLevelPortInterface histogram_rdy ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface timestamp DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_timestamp.dat}
	...
	dict set TopLevelPortInterface timestamp ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface tmi_miso_busy DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_tmi_miso_busy.dat}
	...
	dict set TopLevelPortInterface tmi_miso_busy ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface tmi_miso_error DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_tmi_miso_error.dat}
	...
	dict set TopLevelPortInterface tmi_miso_error ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface tmi_miso_idle DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_tmi_miso_idle.dat}
	...
	dict set TopLevelPortInterface tmi_miso_idle ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface tmi_miso_rd_data DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_tmi_miso_rd_data.dat}
	...
	dict set TopLevelPortInterface tmi_miso_rd_data ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface tmi_miso_rd_dval DatFile {histogram_axis_tmi_4pix_axis16_histogram_4pix_tmi_miso_rd_dval.dat}
	...
	dict set TopLevelPortInterface tmi_miso_rd_dval ClockDomain {histogram_axis_tmi_4pix}
	...
	dict set TopLevelPortInterface clk ClockDomain {histogram_axis_tmi_4pix}
