...
library work;
entity histogram_axis_tmi_4pix_stub is
  port (
    areset : in std_logic;
...
end histogram_axis_tmi_4pix_stub;
architecture structural of histogram_axis_tmi_4pix_stub is 
begin
  sysgen_dut : entity work.histogram_axis_tmi_4pix 
  port map (
    areset => areset,
    clear_mem => clear_mem,
