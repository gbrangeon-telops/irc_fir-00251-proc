...
library work;
entity histogram_axis_tmi_2pix_stub is
  port (
    areset : in std_logic;
...
end histogram_axis_tmi_2pix_stub;
architecture structural of histogram_axis_tmi_2pix_stub is 
begin
  sysgen_dut : entity work.histogram_axis_tmi_2pix 
  port map (
    areset => areset,
    clear_mem => clear_mem,
