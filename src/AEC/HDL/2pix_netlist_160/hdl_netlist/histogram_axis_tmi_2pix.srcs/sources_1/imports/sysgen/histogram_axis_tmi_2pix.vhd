-- Generated from Simulink block histogram_AXIS_TMI_2pix/AXIS16_Histogram_2pix/Add_Gen
library IEEE;
use IEEE.std_logic_1164.all;
library work;
use work.conv_pkg.all;
entity histogram_axis_tmi_2pix_add_gen is
  port (
...
end histogram_axis_tmi_2pix_add_gen;
architecture structural of histogram_axis_tmi_2pix_add_gen is 
...
begin
  ...
  d7_q_net <= add_pix2;
  and_y_net <= dvalid;
  mux2 : entity work.sysgen_mux_7679a1e8ab 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  c1 : entity work.sysgen_constant_b58cd2f8e6 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux1 : entity work.sysgen_mux_7679a1e8ab 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block histogram_AXIS_TMI_2pix/AXIS16_Histogram_2pix/Data_to_Addr
library IEEE;
use IEEE.std_logic_1164.all;
library work;
use work.conv_pkg.all;
entity histogram_axis_tmi_2pix_data_to_addr is
  port (
...
end histogram_axis_tmi_2pix_data_to_addr;
architecture structural of histogram_axis_tmi_2pix_data_to_addr is 
  signal xtoadd7_y_net : std_logic_vector( 7-1 downto 0 );
  signal mux4_y_net : std_logic_vector( 7-1 downto 0 );
  signal mux1_y_net : std_logic_vector( 7-1 downto 0 );
  signal rx_tdata_net : std_logic_vector( 32-1 downto 0 );
...
begin
  ...
  rx_tdata_net <= data;
  msb_pos_net <= msb_pos;
  mux4 : entity work.sysgen_mux_ad253a203d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  xtoadd : entity work.histogram_axis_tmi_2pix_xlslice 
  generic map (
    new_lsb => 6,
    new_msb => 12,
    x_width => 16,
  ...
  xtoadd1 : entity work.histogram_axis_tmi_2pix_xlslice 
  generic map (
    new_lsb => 7,
    new_msb => 13,
    x_width => 16,
  ...
  xtoadd2 : entity work.histogram_axis_tmi_2pix_xlslice 
  generic map (
    new_lsb => 8,
    new_msb => 14,
    x_width => 16,
  ...
  xtoadd3 : entity work.histogram_axis_tmi_2pix_xlslice 
  generic map (
    new_lsb => 9,
    new_msb => 15,
    x_width => 16,
  ...
  pix1_slice : entity work.histogram_axis_tmi_2pix_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 15,
    x_width => 32,
  ...
  pix2_slice : entity work.histogram_axis_tmi_2pix_xlslice 
  generic map (
    new_lsb => 16,
    new_msb => 31,
    x_width => 32,
  ...
  xtoadd4 : entity work.histogram_axis_tmi_2pix_xlslice 
  generic map (
    new_lsb => 6,
    new_msb => 12,
    x_width => 16,
  ...
  xtoadd5 : entity work.histogram_axis_tmi_2pix_xlslice 
  generic map (
    new_lsb => 7,
    new_msb => 13,
    x_width => 16,
  ...
  xtoadd6 : entity work.histogram_axis_tmi_2pix_xlslice 
  generic map (
    new_lsb => 8,
    new_msb => 14,
    x_width => 16,
  ...
  xtoadd7 : entity work.histogram_axis_tmi_2pix_xlslice 
  generic map (
    new_lsb => 9,
    new_msb => 15,
    x_width => 16,
  ...
  mux1 : entity work.sysgen_mux_ad253a203d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block histogram_AXIS_TMI_2pix/AXIS16_Histogram_2pix/Hist_ram_pix1
library IEEE;
use IEEE.std_logic_1164.all;
library work;
use work.conv_pkg.all;
entity histogram_axis_tmi_2pix_hist_ram_pix1 is
  port (
...
end histogram_axis_tmi_2pix_hist_ram_pix1;
architecture structural of histogram_axis_tmi_2pix_hist_ram_pix1 is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  addsub1 : entity work.histogram_axis_tmi_2pix_xladdsub 
  generic map (
    a_arith => xlUnsigned,
    a_bin_pt => 0,
    a_width => 21,
    ...
    c_latency => 0,
    c_output_width => 22,
    core_name0 => "histogram_axis_tmi_2pix_c_addsub_v12_0_i0",
    extra_registers => 0,
    full_s_arith => 1,
    full_s_width => 22,
    latency => 0,
  ...
  constant_x0 : entity work.sysgen_constant_cc715ae3c8 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux : entity work.sysgen_mux_16a2c363d4 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux3 : entity work.sysgen_mux_7679a1e8ab 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational : entity work.sysgen_relational_e2e6c47721 
  port map (
    clr => '0',
    a => d1_q_net,
    b => mux2_y_net,
  ...
  and1 : entity work.sysgen_logical_efd15858bb 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  c3 : entity work.sysgen_constant_9946b2b278 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  d1 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  d13 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  d2 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  d3 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  dp_ram : entity work.histogram_axis_tmi_2pix_xldpram 
  generic map (
    c_address_width_a => 7,
    c_address_width_b => 7,
    c_width_a => 21,
    c_width_b => 21,
    core_name0 => "histogram_axis_tmi_2pix_blk_mem_gen_v8_3_i0",
    latency => 1
  )
  port map (
    ena => "1",
...
-- Generated from Simulink block histogram_AXIS_TMI_2pix/AXIS16_Histogram_2pix/Hist_ram_pix2
library IEEE;
use IEEE.std_logic_1164.all;
library work;
use work.conv_pkg.all;
entity histogram_axis_tmi_2pix_hist_ram_pix2 is
  port (
    wea : in std_logic_vector( 1-1 downto 0 );
    hist_rdy : in std_logic_vector( 1-1 downto 0 );
    add : in std_logic_vector( 7-1 downto 0 );
...
end histogram_axis_tmi_2pix_hist_ram_pix2;
architecture structural of histogram_axis_tmi_2pix_hist_ram_pix2 is 
  signal relational_op_net : std_logic_vector( 1-1 downto 0 );
  signal d1_q_net : std_logic_vector( 7-1 downto 0 );
  signal d13_q_net : std_logic_vector( 1-1 downto 0 );
  signal c3_op_net : std_logic_vector( 21-1 downto 0 );
...
-- Generated from Simulink block histogram_AXIS_TMI_2pix/AXIS16_Histogram_2pix/HistogramState/SOF_GEN
library IEEE;
use IEEE.std_logic_1164.all;
library work;
use work.conv_pkg.all;
entity histogram_axis_tmi_2pix_sof_gen is
  port (
...
end histogram_axis_tmi_2pix_sof_gen;
architecture structural of histogram_axis_tmi_2pix_sof_gen is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  logical13 : entity work.sysgen_logical_efd15858bb 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  register1 : entity work.histogram_axis_tmi_2pix_xlregister 
  generic map (
    d_width => 1,
    init_value => b"1"
  )
...
-- Generated from Simulink block histogram_AXIS_TMI_2pix/AXIS16_Histogram_2pix/HistogramState
library IEEE;
use IEEE.std_logic_1164.all;
library work;
use work.conv_pkg.all;
entity histogram_axis_tmi_2pix_histogramstate is
  port (
...
end histogram_axis_tmi_2pix_histogramstate;
architecture structural of histogram_axis_tmi_2pix_histogramstate is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  sof_gen : entity work.histogram_axis_tmi_2pix_sof_gen 
  port map (
    tlast => d8_q_net,
    dval => and_y_net,
    areset => areset_net,
  ...
  constant_x0 : entity work.sysgen_constant_7a614aaba0 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant1 : entity work.sysgen_constant_cc715ae3c8 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant2 : entity work.sysgen_constant_b58cd2f8e6 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  inverter1 : entity work.sysgen_inverter_8275dba70a 
  port map (
    clr => '0',
    ip => logical1_y_net,
    clk => clk_net,
  ...
  inverter2 : entity work.sysgen_inverter_8275dba70a 
  port map (
    clr => '0',
    ip => mux_y_net,
    clk => clk_net,
  ...
  inverter3 : entity work.sysgen_inverter_8275dba70a 
  port map (
    clr => '0',
    ip => logical9_y_net,
    clk => clk_net,
  ...
  inverter4 : entity work.sysgen_inverter_8275dba70a 
  port map (
    clr => '0',
    ip => logical9_y_net,
    clk => clk_net,
  ...
  inverter5 : entity work.sysgen_inverter_8275dba70a 
  port map (
    clr => '0',
    ip => logical2_y_net,
    clk => clk_net,
  ...
  inverter7 : entity work.sysgen_inverter_8275dba70a 
  port map (
    clr => '0',
    ip => mux_y_net,
    clk => clk_net,
  ...
  inverter8 : entity work.sysgen_inverter_8275dba70a 
  port map (
    clr => '0',
    ip => logical9_y_net,
    clk => clk_net,
  ...
  logical : entity work.sysgen_logical_075c479894 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical1 : entity work.sysgen_logical_fbc626b729 
  port map (
    clr => '0',
    d0 => d8_q_net,
    d1 => logical2_y_net,
  ...
  logical11 : entity work.sysgen_logical_efd15858bb 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical2 : entity work.sysgen_logical_efd15858bb 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical3 : entity work.sysgen_logical_33772f0317 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical4 : entity work.sysgen_logical_efd15858bb 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical5 : entity work.sysgen_logical_33772f0317 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical6 : entity work.sysgen_logical_efd15858bb 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical7 : entity work.sysgen_logical_89ab4b525f 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical8 : entity work.sysgen_logical_efd15858bb 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical9 : entity work.sysgen_logical_33772f0317 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux : entity work.sysgen_mux_a6dc392d56 
  port map (
    clr => '0',
    sel => logical6_y_net,
    d0 => constant_op_net,
  ...
  relational : entity work.sysgen_relational_15627e6cf6 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  timestamp_cntr : entity work.sysgen_counter_a08cb37e8c 
  port map (
    clr => '0',
    clk => clk_net,
    ce => ce_net,
  ...
  clrmem_cntr : entity work.histogram_axis_tmi_2pix_xlcounter_limit 
  generic map (
    cnt_15_0 => 127,
    cnt_31_16 => 0,
    cnt_47_32 => 0,
    cnt_63_48 => 0,
    core_name0 => "histogram_axis_tmi_2pix_c_counter_binary_v12_0_i0",
    count_limited => 0,
    op_arith => xlUnsigned,
    op_width => 7
  )
  ...
  reg1 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  reg2 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  reg3 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
...
-- Generated from Simulink block histogram_AXIS_TMI_2pix/AXIS16_Histogram_2pix/TMI
library IEEE;
use IEEE.std_logic_1164.all;
library work;
use work.conv_pkg.all;
entity histogram_axis_tmi_2pix_tmi is
  port (
...
end histogram_axis_tmi_2pix_tmi;
architecture structural of histogram_axis_tmi_2pix_tmi is 
...
begin
  ...
  d11_q_net <= rnw;
  d12_q_net <= dval;
  bin_adder_s_net <= doutb;
  mux_y_net_x0 <= hist_rdy;
  areset_net <= areset;
  clk_net <= clk_1;
  ce_net <= ce_1;
  mux : entity work.sysgen_mux_d0a9e3fd17 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux1 : entity work.sysgen_mux_d0a9e3fd17 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux2 : entity work.sysgen_mux_d0a9e3fd17 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux3 : entity work.sysgen_mux_d0a9e3fd17 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  and2 : entity work.sysgen_logical_33772f0317 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  and3 : entity work.sysgen_logical_efd15858bb 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  and4 : entity work.sysgen_logical_efd15858bb 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  and5 : entity work.sysgen_logical_075c479894 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  c1 : entity work.sysgen_constant_7a614aaba0 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  c2 : entity work.sysgen_constant_7a614aaba0 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  c3 : entity work.sysgen_constant_cc715ae3c8 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  c4 : entity work.sysgen_constant_7a614aaba0 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  d5 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  inv1 : entity work.sysgen_inverter_8275dba70a 
  port map (
    clr => '0',
    ip => and2_y_net,
    clk => clk_net,
  ...
  inv2 : entity work.sysgen_inverter_8275dba70a 
  port map (
    clr => '0',
    ip => mux_y_net_x0,
    clk => clk_net,
  ...
  inv3 : entity work.sysgen_inverter_8275dba70a 
  port map (
    clr => '0',
    ip => d11_q_net,
    clk => clk_net,
  ...
  inv4 : entity work.sysgen_inverter_8275dba70a 
  port map (
    clr => '0',
    ip => and3_y_net,
    clk => clk_net,
  ...
  inv5 : entity work.sysgen_inverter_8275dba70a 
  port map (
    clr => '0',
    ip => inv1_op_net,
    clk => clk_net,
...
-- Generated from Simulink block histogram_AXIS_TMI_2pix/AXIS16_Histogram_2pix
library IEEE;
use IEEE.std_logic_1164.all;
library work;
use work.conv_pkg.all;
entity histogram_axis_tmi_2pix_axis16_histogram_2pix is
  port (
    areset : in std_logic_vector( 1-1 downto 0 );
    ...
    ext_data_in2 : in std_logic_vector( 32-1 downto 0 );
    msb_pos : in std_logic_vector( 2-1 downto 0 );
    rx_tdata : in std_logic_vector( 32-1 downto 0 );
...
end histogram_axis_tmi_2pix_axis16_histogram_2pix;
architecture structural of histogram_axis_tmi_2pix_axis16_histogram_2pix is 
  ...
  signal mux_y_net : std_logic_vector( 1-1 downto 0 );
  signal mux3_y_net : std_logic_vector( 1-1 downto 0 );
  signal mux1_y_net_x1 : std_logic_vector( 1-1 downto 0 );
  signal bin_adder_s_net : std_logic_vector( 21-1 downto 0 );
  signal mux2_y_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  tmi_miso_idle <= mux1_y_net_x1;
  tmi_miso_rd_data <= bin_adder_s_net;
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  add_gen : entity work.histogram_axis_tmi_2pix_add_gen 
  port map (
    add_pix1 => d4_q_net,
    add_pix2 => d7_q_net,
    dvalid => and_y_net,
  ...
  data_to_addr : entity work.histogram_axis_tmi_2pix_data_to_addr 
  port map (
    data => rx_tdata_net,
    msb_pos => msb_pos_net,
    add_1 => mux4_y_net,
  ...
  hist_ram_pix1 : entity work.histogram_axis_tmi_2pix_hist_ram_pix1 
  port map (
    wea => logical8_y_net,
  ...
  hist_ram_pix2 : entity work.histogram_axis_tmi_2pix_hist_ram_pix2 
  port map (
    wea => logical8_y_net,
    hist_rdy => mux_y_net_x0,
    add => mux1_y_net_x0,
  ...
  histogramstate : entity work.histogram_axis_tmi_2pix_histogramstate 
  port map (
    eof => d8_q_net,
    clearmem => d9_q_net,
    dval => and_y_net,
  ...
  tmi : entity work.histogram_axis_tmi_2pix_tmi 
  port map (
    add_in => d10_q_net,
    rnw => d11_q_net,
    dval => d12_q_net,
    doutb => bin_adder_s_net,
    hist_rdy => mux_y_net_x0,
    areset => areset_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  and_x0 : entity work.sysgen_logical_efd15858bb 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  d10 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  d11 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  d12 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  d14 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  d15 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  d4 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  d6 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  d8 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  d9 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  d7 : entity work.histogram_axis_tmi_2pix_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  bin_adder : entity work.histogram_axis_tmi_2pix_xladdsub 
  generic map (
    a_arith => xlUnsigned,
    a_bin_pt => 0,
    a_width => 21,
...
-- Generated from Simulink block histogram_AXIS_TMI_2pix_struct
library IEEE;
use IEEE.std_logic_1164.all;
library work;
use work.conv_pkg.all;
entity histogram_axis_tmi_2pix_struct is
  port (
    areset : in std_logic_vector( 1-1 downto 0 );
    clear_mem : in std_logic_vector( 1-1 downto 0 );
    ext_data_in : in std_logic_vector( 32-1 downto 0 );
...
end histogram_axis_tmi_2pix_struct;
architecture structural of histogram_axis_tmi_2pix_struct is 
  signal rx_tdata_net : std_logic_vector( 32-1 downto 0 );
  signal rx_tlast_net : std_logic_vector( 1-1 downto 0 );
  signal rx_tready_net : std_logic_vector( 1-1 downto 0 );
  signal rx_tvalid_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  axis16_histogram_2pix : entity work.histogram_axis_tmi_2pix_axis16_histogram_2pix 
  port map (
    areset => areset_net,
...
library work;
use work.conv_pkg.all;
entity histogram_axis_tmi_2pix_default_clock_driver is
  port (
    histogram_axis_tmi_2pix_sysclk : in std_logic;
    histogram_axis_tmi_2pix_sysce : in std_logic;
    histogram_axis_tmi_2pix_sysclr : in std_logic;
    histogram_axis_tmi_2pix_clk1 : out std_logic;
    histogram_axis_tmi_2pix_ce1 : out std_logic
  );
end histogram_axis_tmi_2pix_default_clock_driver;
architecture structural of histogram_axis_tmi_2pix_default_clock_driver is 
begin
  ...
  port map (
    sysclk => histogram_axis_tmi_2pix_sysclk,
    sysce => histogram_axis_tmi_2pix_sysce,
    sysclr => histogram_axis_tmi_2pix_sysclr,
    clk => histogram_axis_tmi_2pix_clk1,
    ce => histogram_axis_tmi_2pix_ce1
  );
end structural;
-- Generated from Simulink block 
library IEEE;
...
library work;
use work.conv_pkg.all;
entity histogram_axis_tmi_2pix is
  port (
    areset : in std_logic;
...
end histogram_axis_tmi_2pix;
architecture structural of histogram_axis_tmi_2pix is 
  attribute core_generation_info : string;
  attribute core_generation_info of structural : architecture is "histogram_axis_tmi_2pix,sysgen_core_2016_3,{,compilation=HDL Netlist,block_icon_display=Default,family=kintex7,part=xc7k160t,speed=-1,package=fbg676,synthesis_language=vhdl,hdl_library=work,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=0,interface_doc=1,ce_clr=0,clock_period=6.25,system_simulink_period=1,waveform_viewer=0,axilite_interface=0,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=1,addsub=3,constant=12,counter=2,delay=26,dpram=2,inv=12,logical=20,mux=15,register=1,relational=3,slice=10,}";
  signal clk_1_net : std_logic;
  signal ce_1_net : std_logic;
begin
  histogram_axis_tmi_2pix_default_clock_driver : entity work.histogram_axis_tmi_2pix_default_clock_driver 
  port map (
    histogram_axis_tmi_2pix_sysclk => clk,
    histogram_axis_tmi_2pix_sysce => '1',
    histogram_axis_tmi_2pix_sysclr => '0',
    histogram_axis_tmi_2pix_clk1 => clk_1_net,
    histogram_axis_tmi_2pix_ce1 => ce_1_net
  );
  histogram_axis_tmi_2pix_struct : entity work.histogram_axis_tmi_2pix_struct 
  port map (
    areset(0) => areset,
