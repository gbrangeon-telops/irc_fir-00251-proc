...
#define FPA_DEVICE_MODEL_NAME    "SCORPIOMWA_27MHz"
...
#define FPA_TDC_FLAGS            (ScorpiomwA_300HzIsImplemented | ITRIsImplementedMask)
...
struct s_FpaIntfConfig    // Remarquer la disparition du champ fpa_integration_time. le temps d'integration n'est plus défini par le module FPA_INTF
{
   ...
   uint32_t   roic_xsize                     ;
   uint32_t   roic_ysize                     ;
   uint32_t   roic_windcfg_part1             ;
   uint32_t   roic_windcfg_part2             ;
   uint32_t   roic_windcfg_part3             ;
   uint32_t   roic_windcfg_part4             ;
   uint32_t   roic_uprow_upcol               ;
   uint32_t   roic_sizea_sizeb               ;
   uint32_t   roic_itr                       ;
   uint32_t   roic_gain                      ;
   uint32_t   roic_gpol_code                 ;
   uint32_t   roic_reset_time_mclk           ;                                             
   uint32_t   diag_ysize                     ;
   ...
   uint32_t   fast1_clk_id_sample_pos        ;
   uint32_t   fast2_clk_id_sample_pos        ;
   uint32_t   tir_dly_adc_clk                ;
