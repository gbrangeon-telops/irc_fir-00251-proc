...
// ELA : Les valeurs par défaut du constructeur ne sont plus activement utilisées comme
//       fpa_init() écrase les bonnes valeurs initiales avant même que le module
//       FPA devienne actif.
