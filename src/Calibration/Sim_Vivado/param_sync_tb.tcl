#*****************************************************************************************
# Vivado (TM) v2018.3_AR71948_AR71898 (64-bit)
#
# param_sync_tb.tcl: Tcl script for re-creating project 'param_sync_tb'
#
# Generated by Vivado on Fri Sep 29 14:44:07 -0400 2023
...
#
# 1. This project restoration tcl script (param_sync_tb.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/Telops/FIR-00251-Proc/src/Calibration/Sim_Vivado/param_sync_tb/param_sync_tb_behav.wcfg"
#
# 3. The following remote source files that were added to the original project:-
#
#    "D:/Telops/FIR-00251-Common/VHDL/tel2000pkg.vhd"
#    "D:/Telops/FIR-00251-Common/VHDL/Utilities/axis32_RandomMiso.vhd"
#    "D:/Telops/FIR-00251-Proc/src/Calibration/HDL/param_sync_to_axis32.vhd"
#    "D:/Telops/Common_HDL/Utilities/sync_reset.vhd"
#    "D:/Telops/FIR-00251-Proc/src/Calibration/Sim_Vivado/param_sync_tb.vhd"
#
#*****************************************************************************************
...
set _xil_proj_name_ "param_sync_tb"
...
set script_file "param_sync_tb.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/param_sync_tb"]"

# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xczu4eg-sfvc784-1-e
...
set_property -name "part" -value "xczu4eg-sfvc784-1-e" -objects $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/../../../../FIR-00251-Common/VHDL/Utilities/axis32_RandomMiso.vhd"] \
 [file normalize "${origin_dir}/../HDL/param_sync_to_axis32.vhd"] \
 [file normalize "${origin_dir}/../../../../Common_HDL/Utilities/sync_reset.vhd"] \
 [file normalize "${origin_dir}/param_sync_tb.vhd"] \
]
...
set file "$origin_dir/../../../../FIR-00251-Common/VHDL/Utilities/axis32_RandomMiso.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../HDL/param_sync_to_axis32.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/param_sync_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "param_sync_tb" -objects $obj
...
set obj [get_filesets constrs_1]
set_property -name "target_part" -value "xczu4eg-sfvc784-1-e" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/param_sync_tb/param_sync_tb_behav.wcfg" ]\
]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu4eg-sfvc784-1-e -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu4eg-sfvc784-1-e -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
