...
// start section for Explora
/**
 * \def SHOW_LOW_ACCESS
 * \note show low level nand access (for test purpose only)
 */
//#define SHOW_LOW_ACCESS

/**
 * \def PERFORMANCE_LOW
 * \note some dirty test (for test purpose only)
 */
//#define PERFORMANCE_LOW

// end section for Explora
 ...
 */
//#define CONFIG_PAGE_WRITE_VERIFY (disable by fdu$$$)
